...
import AdriaticNoNightTourDescriptionCss from "./AdriaticNoNightTourDescription.module.scss";
// import FeedbackForm from "../../feedback-form/FeedbackForm";
// import Modal from "../../modal/Modal";
import Buttonmodal from "../../feedback-form/button-modal/Buttonmodal";
import "./AdriaticNoNightTourDescription.scss";

const AdriaticNoNightTourDescription = () => {
  window.scrollTo(0, 0);
  ...
  useEffect(() => {
    axios
      .post(`https://turyukr.com/api/tours/get-itemadriaticnonight/${title}`)
      .then((res) => {
        if (res.status === 200) {
  ...
  // };
  return (
    <div className={AdriaticNoNightTourDescriptionCss.container}>
      <div id="tour_my_calendar" class="calendar_block no-print">
        <div dangerouslySetInnerHTML={{ __html: discript.calendarTour }}></div>
      </div>
      <div className={AdriaticNoNightTourDescriptionCss.tabs}>
        <button
          className={`${AdriaticNoNightTourDescriptionCss.tab} ${
            activeTab === "about_tour" &&
            AdriaticNoNightTourDescriptionCss.active
          }`}
        ...
        <button
          className={`${AdriaticNoNightTourDescriptionCss.tab} ${
            activeTab === "program" && AdriaticNoNightTourDescriptionCss.active
          }`}
      ...
      <div
        id="about_tour"
        className={`${AdriaticNoNightTourDescriptionCss.tabContent} ${
          activeTab === "about_tour" &&
          AdriaticNoNightTourDescriptionCss.activeTabContent
        }`}
...
export default AdriaticNoNightTourDescription;
